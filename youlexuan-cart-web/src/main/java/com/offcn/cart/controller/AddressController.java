...
public class AddressController {
    ...
    @RequestMapping("/byProvinceIdFindCities")
    public List<TbCities> byProvinceIdFindCities(String provinceId) {
        return addressService.byProvinceIdFindCities(provinceId);
    }

    @RequestMapping("/byCityIdFindAreas")
    public List<TbAreas> byCityIdFindAreas(String cityId) {
        return addressService.byCityIdFindAreas(cityId);
    }
}
